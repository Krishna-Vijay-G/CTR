        ...
        <div className="footer-main">
          <div className="footer-brand">
            ...
            <div className="social-links">
              ...
              <a href={socialMedia.twitter} target="_blank" rel="noopener noreferrer" className="social-link" aria-label="X/Twitter">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="footer-column">
            ...
            <div className="footer-links">
              ...
              <Link href="/schedule" className="footer-link">Calendar</Link>
          ...
          <div className="footer-column">
            <h4>Contact</h4>
            <div className="footer-links">
              <span className="footer-link">{contact.email}</span>
              <span className="footer-link">{site.headquarters}</span>
            </div>
          </div>
        </div>
